    ...
    <div className="navbar">
              ...
              <div className="dropdown-wrapper">
                <div className="first-line">
                  ...
                  <ul>
                    ...
                    <li>
                      <img src={poverpoint} alt="poverpoint" />
                ...
                <div className="second-line">
                  ...
                  <ul>
                    ...
                    <li>
                      <img src={poverpoint2} alt="poverpoint2" />
                      <span>PDF to POWERPOINT</span>
                    </li>
                    <li>
                      <img src={exel2} alt="exel2" />
                      <span>PDF to EXCEL</span>
                    </li>
                    <li>
                      <img src={pdfA} alt="pdf/A" />
              ...
              <div className="dropdown-wrapper2 flex-jcsa">
                <div className="line1">
                  <ul>
                    ...
                    <li>
                      <img src={merge} alt="svg" />
                      <span>MERGE PDF</span>
                    </li>
                    <li>
                      <img src={split} alt="svg" />
                      <span>SPLIT PDF</span>
                    </li>
                    <li>
                      <img src={iks} alt="" />
                ...
                <div className="line2">
                  <ul>
                    ...
                    <li>
                      <img src={compress} alt="svg" />
                      <span>COMPRESS PDF</span>
                    </li>
                    <li>
                      <img src={repair} alt="svg" />
                ...
                <div className="line5">
                  <ul>
                    ...
                    <li>
                      <img src={rotate} alt="svg" />
                      <span>Rotate PDF</span>
                    </li>
                    <li>
                      <img src={numbers} alt="svg" />
                      <span>Add page numbers</span>
                    </li>
                    <li>
                      <img src={watermark} alt="svg" />
                ...
                <div className="line5">
                  <ul>
                    ...
                    <li>
                      <img src={unlock} alt="svg" />
                      <span>Unlock PDF</span>
                    </li>
                    <li>
                      <img src={protect} alt="svg" />
                      <span>Protect PDF</span>
                    </li>
                    <li>
                      <img src={sign} alt="svg" />
                      <span>Sign PDF</span>
                    </li>
                  </ul>
                </div>
      ...
      <div className="right-corner">
        ...
        <div className="right-corner-box">
          <ul>
            <li>
              <img className="first-img" src={logoCopy} alt="" />
              <span className="first-span">Home</span>
            </li>
            <li className="product-list">
              <FiBox style={{ color: "grey" }} />
              <span className="second-span">Product</span>
              <KeyboardArrowRightSharpIcon className="icon first-arrow" />
            ...
            <li className="solution-list">
              <TipsAndUpdatesSharpIcon style={{ color: "grey" }} />
              <span>Solution</span>
            ...
            <li>
              <PaymentSharpIcon style={{ color: "grey" }} />
              <span>Pricing</span>
            </li>
            <li>
              <LanguageSharpIcon style={{ color: "grey" }} />
              <span>Language</span>
              <KeyboardArrowRightSharpIcon className="icon third-arrow" />
            </li>
            <li className="help-list">
              <HelpSharpIcon style={{ color: "grey" }} />
              <span>Help</span>
              <KeyboardArrowRightSharpIcon className="icon fourth-arrow" />
            ...
            <li>
              <img
                ...
                alt=""
              />
              <span className="last-span">iLoveIMG</span>
            </li>
          </ul>
        </div>
      </div>
